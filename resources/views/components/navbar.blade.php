<nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Mosphere</span>
        </a>
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul
                ...
                {{-- using reusable navbar-link.blade.php --}}
                {{-- :active="true" to override the component props --}}
                ...
                {{-- check if the logged user's is_admin = 1 --}}
                @if (Auth::check() && Auth::user()->is_admin)
                    <x-navbar-link href="/admin" :active="request()->is('admin')">Admin Page</x-navbar-link>
                @endif
